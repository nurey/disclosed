...
# GAE: removed ObjectDoesNotExist
...
# GAE: Added queryset parameter (needed by object_detail)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if request.user.is_authenticated():
                ...
                Message(request.user, message=ugettext("The %(verbose_name)s was created successfully.") % {"verbose_name": model._meta.verbose_name}).put()
...
def update_object(request, model=None, object_id=None, slug=None,
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if request.user.is_authenticated():
                # GAE: Create message with constructor
                Message(request.user, message=ugettext("The %(verbose_name)s was updated successfully.") % {"verbose_name": model._meta.verbose_name}).put()
